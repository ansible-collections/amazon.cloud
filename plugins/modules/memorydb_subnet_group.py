...
- A subnet group is a collection of subnets (typically private) that you can designate
    ...
    When you create a MemoryDB cluster, you must specify a subnet group. MemoryDB
    uses that subnet group to choose a subnet and IP addresses within that subnet
...
def main():
    ...
    type_name = "AWS::MemoryDB::SubnetGroup"
    ...
    create_only_params = ["SubnetGroupName"]
