...
DOCUMENTATION = r"""
module: wafv2_regex_pattern_set
...
options:
    ...
    scope:
        ...
        - REGIONAL
        description:
        - Use CLOUDFRONT for CloudFront RegexPatternSet, use REGIONAL for Application
...
def main():
    ...
    argument_spec["regular_expression_list"] = {"type": "list", "elements": "str"}
    ...
    required_if = [
        ...
        [
            "state",
            "present",
            ["regular_expression_list", "identifier", "scope", "id", "name"],
            True,
        ],
    ...
    type_name = "AWS::WAFv2::RegexPatternSet"
