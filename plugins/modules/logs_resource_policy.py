...
def main():
    ...
    argument_spec["policy_name"] = {"type": "str", "aliases": ["PolicyName"]}
    argument_spec["policy_document"] = {"type": "str", "aliases": ["PolicyDocument"]}
    argument_spec["state"] = {
        "type": "str",
        "choices": ["present", "absent", "list", "describe", "get"],
        "default": "present",
    ...
    required_if = [
        ["state", "present", ["policy_name", "policy_document"], True],
    ...
    create_only_params = ["/properties/PolicyName"]

    # Necessary to handle when module does not support all the states
    handlers = ["create", "read", "update", "delete", "list"]

    state = module.params.get("state")
    identifier = ["/properties/PolicyName"]
