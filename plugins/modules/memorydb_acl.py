...
description:
- Creates and manages an Access Control List (ACL) to specify permissions to a MemoryDB
...
def main():
    ...
    required_if = [
        ["state", "present", ["acl_name", "ACLName"], True],
        ["state", "absent", ["acl_name"], True],
        ["state", "get", ["acl_name"], True],
    ]
    mutually_exclusive = []
