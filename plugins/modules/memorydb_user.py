...
def main():
    ...
    type_name = "AWS::MemoryDB::User"

    params = {}

    params["access_string"] = module.params.get("access_string")
    params["authentication_mode"] = module.params.get("authentication_mode")
    ...
    create_only_params = ["/properties/UserName"]

    # Necessary to handle when module does not support all the states
    handlers = ["create", "read", "update", "delete", "list"]

    state = module.params.get("state")
    identifier = ["/properties/UserName"]
