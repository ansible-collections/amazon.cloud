...
DOCUMENTATION = r"""
module: rds_db_cluster_parameter_group
...
options:
    ...
    family:
        ...
        - A DB cluster parameter group can be associated with one and only one DB
            cluster parameter group family, and can be applied only to a DB cluster
            running a DB engine and engine version compatible with that DB cluster
...
def main():
    ...
    argument_spec["db_cluster_parameter_group_name"] = {"type": "str"}
    ...
    required_if = [
        [
            "state",
            "present",
            ["family", "db_cluster_parameter_group_name", "parameters", "description"],
            True,
        ],
        ["state", "absent", ["db_cluster_parameter_group_name"], True],
        ["state", "get", ["db_cluster_parameter_group_name"], True],
    ]
    mutually_exclusive = []
    ...
    type_name = "AWS::RDS::DBClusterParameterGroup"
    ...
    create_only_params = ["db_cluster_parameter_group_name", "description", "family"]
