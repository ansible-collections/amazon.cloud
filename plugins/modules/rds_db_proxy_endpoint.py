...
def main():
    ...
    argument_spec["db_proxy_endpoint_name"] = {
        "type": "str",
        "aliases": ["DBProxyEndpointName"],
    }
    ...
    create_only_params = ["DBProxyName", "DBProxyEndpointName", "VpcSubnetIds"]

    # Necessary to handle when module does not support all the states
    handlers = ["create", "read", "update", "delete", "list"]

    state = module.params.get("state")
    identifier = ["DBProxyEndpointName"]
