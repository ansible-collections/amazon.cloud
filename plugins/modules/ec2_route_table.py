...
DOCUMENTATION = r"""
module: ec2_route_table
short_description: Create and manage route tables for AWS virtual private clouds (VPCs)
description: Create and manage route tables for AWS VPCs (list, create, update, describe,
    delete).
options:
    route_table_id:
        description:
...
def main():
    ...
    argument_spec["route_table_id"] = {"type": "str"}
    argument_spec["tags"] = {
        "type": "list",
        "elements": "dict",
        "suboptions": {
    ...
    required_if = [
        ["state", "create", ["route_table_id", "vpc_id"], True],
        ["state", "update", ["route_table_id"], True],
        ["state", "delete", ["route_table_id"], True],
        ["state", "get", ["route_table_id"], True],
    ]
    ...
    identifier = module.params.get("route_table_id")
    ...
    if state == "update":
        ...
        create_only_params = ["/properties/VpcId"]
