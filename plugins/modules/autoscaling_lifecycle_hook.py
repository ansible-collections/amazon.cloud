...
def main():
    ...
    argument_spec["default_result"] = {"type": "str"}
    argument_spec["heartbeat_timeout"] = {"type": "int"}
    argument_spec["lifecycle_hook_name"] = {"type": "str"}
    argument_spec["lifecycle_transition"] = {"type": "str"}
    argument_spec["notification_metadata"] = {"type": "str"}
    argument_spec["notification_target_arn"] = {"type": "str"}
    ...
    create_only_params = ["auto_scaling_group_name", "lifecycle_hook_name"]
