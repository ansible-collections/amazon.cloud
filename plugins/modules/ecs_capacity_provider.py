...
def main():
    ...
    argument_spec["auto_scaling_group_provider"] = {
        "type": "dict",
        "options": {
            "auto_scaling_group_arn": {"type": "str"},
            "managed_scaling": {
                "type": "dict",
                "options": {
                    "minimum_scaling_step_size": {"type": "int"},
                    "maximum_scaling_step_size": {"type": "int"},
                    "status": {"type": "str", "choices": ["DISABLED", "ENABLED"]},
                    "target_capacity": {"type": "int"},
                    "instance_warmup_period": {"type": "int"},
                },
            },
            "managed_termination_protection": {
                "type": "str",
    ...
    create_only_params = ["auto_scaling_group_arn", "name"]
