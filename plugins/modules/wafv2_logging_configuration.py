...
def main():
    ...
    argument_spec["resource_arn"] = {"type": "str"}
    argument_spec["log_destination_configs"] = {"type": "list", "elements": "str"}
            ...
            "json_body": {
                ...
                "options": {
                    ...
                    "match_pattern": {
                        ...
                        "options": {
                            "all": {"type": "dict"},
                            "included_paths": {"type": "list", "elements": "str"},
                        },
                    },
                    "match_scope": {"type": "str", "choices": ["ALL", "KEY", "VALUE"]},
                },
            },
            "method": {"type": "dict"},
            "query_string": {"type": "dict"},
            "single_header": {"type": "dict", "options": {"name": {"type": "str"}}},
            "uri_path": {"type": "dict"},
        },
    }
    argument_spec["logging_filter"] = {
        "type": "dict",
        "options": {
            "default_behavior": {"type": "str", "choices": ["DROP", "KEEP"]},
            "filters": {
                "type": "list",
                "elements": "dict",
                "options": {
                    "behavior": {"type": "str", "choices": ["DROP", "KEEP"]},
                    "conditions": {
                        "type": "list",
                        "elements": "dict",
                        "options": {
    ...
    create_only_params = ["resource_arn"]
