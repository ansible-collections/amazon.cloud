...
- Subnet groups must contain at least two subnets in two different Availability Zones
    in the same region.
options:
...
def main():
    ...
    argument_spec["db_subnet_group_description"] = {"type": "str"}
    ...
    required_if = [
        ...
        ["state", "get", ["db_subnet_group_name"], True],
    ]
    mutually_exclusive = []
    ...
    type_name = "AWS::RDS::DBSubnetGroup"

    params = {}

    params["db_subnet_group_description"] = module.params.get(
        "db_subnet_group_description"
    )
    params["db_subnet_group_name"] = module.params.get("db_subnet_group_name")
    params["subnet_ids"] = module.params.get("subnet_ids")
    ...
    create_only_params = ["db_subnet_group_name"]
