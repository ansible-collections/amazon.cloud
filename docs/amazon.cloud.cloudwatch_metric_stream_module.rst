.. _amazon.cloud.cloudwatch_metric_stream_module:


*************************************
amazon.cloud.cloudwatch_metric_stream
*************************************
...
- For more information, see https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Metric-Streams.html.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>This structure defines the metrics that will be streamed.</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>Only metrics with Namespace matching this value will be streamed.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The ARN of the Kinesis Firehose where to stream the data.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        <div>Name of the metric stream.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td>
                        <div>The output format of the data streamed to the Kinesis Firehose.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        <div>The ARN of the role that provides access to the Kinesis Firehose.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        <div>This structure specifies a list of additional statistics to stream, and the metrics to stream those additional statistics for.</div>
                        <div>All metrics that match the combination of metric name and namespace will be streamed with the extended statistics, no matter their dimensions.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The additional statistics to stream for the metrics listed in <em>include_metrics</em>.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>A structure that specifies the metric name and namespace for one metric that is going to have additional statistics included in the stream.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
