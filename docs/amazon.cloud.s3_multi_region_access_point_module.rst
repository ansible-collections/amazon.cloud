.. _amazon.cloud.s3_multi_region_access_point_module:


*****************************************
amazon.cloud.s3_multi_region_access_point
*****************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name you want to assign to this Multi Region Access Point.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The <em>public_access_block</em> configuration that you want to apply to this Multi Region Access Point.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the bucket that represents of the region belonging to this Multi Region Access Point.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
