.. _amazon.cloud.rds_db_proxy_endpoint_module:


**********************************
amazon.cloud.rds_db_proxy_endpoint
**********************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The identifier for the DB proxy endpoint.</div>
                        <div>This name must be unique for all DB proxy endpoints owned by your AWS account in the specified AWS Region.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A value that indicates whether the DB proxy endpoint can be used for read/write or read-only operations.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>VPC security group IDs to associate with the new DB proxy endpoint.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>VPC subnet IDs to associate with the new DB proxy endpoint.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
