.. _amazon.cloud.logs_query_definition_module:


**********************************
amazon.cloud.logs_query_definition
**********************************

**Create and manage query definitions**
...
Synopsis
--------
- Creates and manage query definitions for CloudWatch Logs Insights (list, create, update, describe, delete).
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A name for the saved query definition</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Unique identifier of a query definition</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The query string to use for this definition</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
