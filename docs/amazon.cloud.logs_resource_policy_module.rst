.. _amazon.cloud.logs_resource_policy_module:


*********************************
amazon.cloud.logs_resource_policy
*********************************

**Create and manage resource policies**
...
Synopsis
--------
- Creates and manage resource policies that allows other AWS services to put log events to the account (list, create, update, describe, delete).
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A name for resource policy</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
