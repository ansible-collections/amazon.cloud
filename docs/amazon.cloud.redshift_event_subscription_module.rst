.. _amazon.cloud.redshift_event_subscription_module:


****************************************
amazon.cloud.redshift_event_subscription
****************************************

**Create and manage Amazon Redshift event notification subscriptions**
...
Synopsis
--------
- Creates and manage Amazon Redshift event notification subscriptions (list, create, update, describe, delete).
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A boolean value; set to true to activate the subscription, and set to false to create the subscription but not activate it.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Specifies the Amazon Redshift event categories to be published by the event notification subscription.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the Amazon Redshift event severity to be published by the event notification subscription.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The Amazon Resource Name (ARN) of the Amazon SNS topic used to transmit the event notifications.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A list of one or more identifiers of Amazon Redshift source objects.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>cluster</li>
                                    <li>cluster-parameter-group</li>
                                    <li>cluster-security-group</li>
                                    <li>cluster-snapshot</li>
                                    <li>scheduled-action</li>
                        </ul>
                </td>
                <td>
                        <div>The type of source that will be generating the events.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The name of the Amazon Redshift event notification subscription</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
