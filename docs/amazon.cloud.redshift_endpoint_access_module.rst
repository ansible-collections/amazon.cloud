.. _amazon.cloud.redshift_endpoint_access_module:


*************************************
amazon.cloud.redshift_endpoint_access
*************************************

**Creates and manages Redshift-managed VPC endpoint**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The AWS account ID of the owner of the cluster.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The subnet group name where Amazon Redshift chooses to deploy the endpoint.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A list of vpc security group ids to apply to the created endpoint access.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
