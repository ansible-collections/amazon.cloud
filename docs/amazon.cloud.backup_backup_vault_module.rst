.. _amazon.cloud.backup_backup_vault_module:


********************************
amazon.cloud.backup_backup_vault
********************************

**Create and manage logical containers where backups are stored**
...
Synopsis
--------
- Creates and manages logical containers where backups are stored (list, create, update, describe, delete).
