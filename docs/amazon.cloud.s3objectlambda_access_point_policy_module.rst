    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the Amazon S3 ObjectLambdaAccessPoint to which the policy applies.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A policy document containing permissions to add to the specified ObjectLambdaAccessPoint.</div>
