.. _amazon.cloud.s3_multi_region_access_point_policy_module:


************************************************
amazon.cloud.s3_multi_region_access_point_policy
************************************************

**Manage Amazon S3 access policies**
...
Synopsis
--------
- Applie and manage Amazon S3 access policies to an Amazon S3 Multi-Region Access Points.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the Multi Region Access Point to apply policy</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Policy document to apply to a Multi Region Access Point</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
