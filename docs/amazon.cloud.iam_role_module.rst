    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The trust policy that is associated with this role.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>A description of the role that you provide.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>A list of Amazon Resource Names (ARNs) of the IAM managed policies that you want to attach to the role.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The maximum session duration (in seconds) that you want to set for the specified role.</div>
                        <div>If you do not specify a value for this setting, the default maximum of one hour is applied.</div>
                        <div>This setting can have a value from 1 hour to 12 hours.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The ARN of the policy used to set the permissions boundary for the role.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The inline policy document that is embedded in the specified IAM role.</div>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The friendly name (not ARN) identifying the policy.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>A name for the IAM role, up to 64 characters in length.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
