.. _amazon.cloud.eks_fargate_profile_module:
...
**Creates and manage AWS Fargate profiles**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Name of FargateProfile.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        <div>The IAM policy arn for pods.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        <div>A key-value pair to associate with a pod.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The key name of the label.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The value for the label.</div>
                </td>
            </tr>
